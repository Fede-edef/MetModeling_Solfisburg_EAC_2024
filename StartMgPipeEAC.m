...
modPath='/home/federico/Documents/AGORA/panModels/';
% path where to save results
resPath='/home/federico/Documents/Quinn/results';
% path to where the COBRA Toolbox is located
global CBTDIR
toolboxPath=CBTDIR;
% path to and name of the file with dietary information.
dietFilePath=[CBTDIR filesep 'papers' filesep '2018_microbiomeModelingToolbox' filesep 'resources' filesep 'HighFatLowCarbDiet'];
% path to and name of the file with abundance information.
abunFilePath='/home/federico/Documents/Quinn/normCoverage.csv';
